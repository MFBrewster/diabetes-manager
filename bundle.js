...
/***/ function(module, exports, __webpack_require__) {
	...
	var userFunc = __webpack_require__(6);
	var medFunc = __webpack_require__(33);
	var viewBox = __webpack_require__(7);

	var editSetIdAndGo = function editSetIdAndGo(e) {
	  e.preventDefault();
	...
	$(document).ready(function () {
	  document.location.hostname === 'localhost' ? globalObjects.baseUrl = 'http://localhost:3000' : globalObjects.baseUrl = 'https://diabetes-manager.herokuapp.com/';
	  viewBox.hide();
	  userHandler();
	  $('#sign-in-window').show();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var successToMain = function successToMain() {
	  viewBox.fadeOut();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var globalObjects = __webpack_require__(5);
	var dataGen = __webpack_require__(8);
	var delayTime = 200;
	...
	var switchTo = {
	  ...
	  newMedicine: function newMedicine() {
	    fadeOut();
	  ...
	  newDose: function newDose() {
	    fadeOut();
	    dataGen.getMeds();
	    $('#new-dose-window').delay(delayTime).fadeIn();
	  },
	  editDose: function editDose() {
	    fadeOut();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayUserMedicines = function displayUserMedicines(medicines) {
	  var medListingTemplate = __webpack_require__(9);
	  $('#med-list').append(medListingTemplate({ medicines: medicines }));
	};

	var userMedicines = function userMedicines() {
	  $.ajax({
	...
	var medicinesDropList = function medicinesDropList(medicines) {
	  var medListingTemplate = __webpack_require__(30);
	  $('.medicine-drop-list').append(medListingTemplate({ medicines: medicines }));
	};

	var getMeds = function getMeds() {
	  $.ajax({
	...
	var displayDoses = function displayDoses(doses) {
	  var medListingTemplate = __webpack_require__(31);
	  $('#dose-list').append(medListingTemplate({ doses: doses }));
	};

	var userDoses = function userDoses() {
	  $.ajax({
	...
	var fillEditField = function fillEditField(dose) {
	...
	var getOneDose = function getOneDose() {
	  $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(29),depth0,{"name":"umed","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.medicines : depth0)) != null ? stack1.medicines : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return container.escapeExpression(((helper = (helper = helpers.notes || (depth0 != null ? depth0.notes : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"notes","hash":{},"data":data}) : helper)));
	},"3":function(container,depth0,helpers,partials,data) {
	    return "No notes on medicine.";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, alias1=depth0 != null ? depth0 : {};

	  return "<div class=\"med listing\">\n  <h3><small>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"dose","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.doses : depth0)) != null ? stack1.doses : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"dose listing\">\n  <h3><small>"
	    + alias4(((helper = (helper = helpers.label || (depth0 != null ? depth0.label : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"label","hash":{},"data":data}) : helper)))
	    + "</small></h3>\n  <p class=\"dose-info\"><span class=\"med-name\">"
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.medicine : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</span>, "
	    ...
	    + " "
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.medicine : depth0)) != null ? stack1.unit_name : stack1), depth0))
	    + ", "
	    + alias4(((helper = (helper = helpers.time || (depth0 != null ? depth0.time : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"time","hash":{},"data":data}) : helper)))
	    + "</p>\n  <p class=\"window-link dose-options\"><span class=\"edit-dose\" data-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">edit</span> |\n     <span class=\"delete-dose\" data-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">delete</span></p>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var returnToNewDose = function returnToNewDose() {
	  $('.as-whom').html(globalObjects.user.email);
	  viewBox.switchTo.newDose();
	};

	var returnToDoses = function returnToDoses() {
	  $('.as-whom').html(globalObjects.user.email);
	  viewBox.switchTo.doses();
	};

	var newMedicine = function newMedicine(e) {
	  e.preventDefault();
	  var formData = new FormData(e.target);
	  $.ajax({
	    url: globalObjects.baseUrl + '/medicines',
	...
	var newDose = function newDose(e) {
	  e.preventDefault();
	  var formData = new FormData(e.target);
	  $.ajax({
	    url: globalObjects.baseUrl + '/doses',
	...
	var editDose = function editDose(e) {
	  e.preventDefault();
	  var formData = new FormData(e.target);
	...
	var deleteDose = function deleteDose(e) {
	  e.preventDefault();
	  var doseId = $(e.target).attr('data-id');
	  console.log(doseId);
	  $.ajax({
